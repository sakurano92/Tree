<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InventoryItemsFlowList.ascx.cs"
                    ...
                    <tr >
                      <%--  <th class="FieldLabel" style="width: 200px" >
                        ...
                        <td class="FieldValue" style="width: 300px">
                            <asp:DropDownList ID="ddlItemCat" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ItemCatChanged" Visible="false">
                            </asp:DropDownList>
                        </td>
                       <%-- <th class="FieldLabel" style="width: 150px">
                        ...
                        <td class="FieldValue" style="width: 300px">
                            <asp:DropDownList ID="ddlItem" runat="server" Width="300" Visible="false">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                ...
                PageSize="50" ShowFooter="false" Width="100%" RowHeaderColumn="Inventory Items Flow">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="price" HeaderText="Amount" ItemStyle-Width="100px" />
                    <%--<asp:BoundField DataField="po_rate" HeaderText="Purchase Rate" ItemStyle-Width="100px" />--%>
